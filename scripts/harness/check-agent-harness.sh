...
required_files=(
  ...
  "scripts/harness/pre-commit-validate.mjs"
  "scripts/harness/pre-push-validate.mjs"
...
expect_executable ".githooks/pre-push"
expect_executable "scripts/harness/pre-commit-validate.mjs"
expect_executable "scripts/harness/pre-push-validate.mjs"
...
expect_contains "README.md" "Conventional Commits"
...
expect_contains ".agents/skills/shared/open-pr/workflow.md" "Conventional Commit format"
...
expect_contains ".githooks/pre-commit" "pre-commit-validate.mjs"
expect_contains ".githooks/pre-commit" "check-sync-drift.mjs"
expect_contains ".githooks/pre-push" "pre-push-validate.mjs"
expect_contains "scripts/harness/pre-commit-validate.mjs" "npm run lint"
expect_contains "scripts/harness/pre-commit-validate.mjs" "npm run style:check"
expect_contains "scripts/harness/pre-commit-validate.mjs" "task lint"
expect_contains "scripts/harness/pre-commit-validate.mjs" "AGENTS.md has"
expect_contains "scripts/harness/pre-commit-validate.mjs" "failing files or rule"
expect_contains "scripts/harness/pre-push-validate.mjs" "harness:check"
expect_contains "scripts/harness/pre-push-validate.mjs" "check-platform-harness.mjs"
expect_contains "scripts/harness/pre-push-validate.mjs" "failing harness rule or file"
